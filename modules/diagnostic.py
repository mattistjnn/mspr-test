...
INFRA = {
    ...
    "DC01": {"ip": "192.168.10.10", "user": "NORD-TRANSIT\\Administrateur", "pwd": "caca3100!", "os": "windows"},
    "DC02": {"ip": "192.168.10.11", "user": "NORD-TRANSIT\\Administrateur", "pwd": "caca3200!", "os": "windows"}
}
